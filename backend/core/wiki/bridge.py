...
ZOPEDIA_TO_UNSLOTH_MAP: dict[str, str] = {
    ...
    "ZOPEDIA_WIKI_AUTO_LINT_EVERY": "UNSLOTH_WIKI_AUTO_LINT_EVERY",
    # Ingestion
    "ZOPEDIA_WIKI_PENDING_INGEST_INTERVAL_SECONDS": "UNSLOTH_WIKI_PENDING_INGEST_INTERVAL_SECONDS",
    "ZOPEDIA_WIKI_PENDING_INGEST_MAX_FILES_PER_CHAT": "UNSLOTH_WIKI_PENDING_INGEST_MAX_FILES_PER_CHAT",
    "ZOPEDIA_WIKI_MAX_ANALYSIS_PAGES": "UNSLOTH_WIKI_MAX_ANALYSIS_PAGES",
    # Community & index
    ...
    # Maintenance
    "ZOPEDIA_WIKI_AUTO_RETRY_FALLBACK_ANALYSES_MAX_PAGES": "UNSLOTH_WIKI_AUTO_RETRY_FALLBACK_ANALYSES_MAX_PAGES",
    "ZOPEDIA_WIKI_MERGE_MAINTENANCE_MAX_MERGES": "UNSLOTH_WIKI_MERGE_MAINTENANCE_MAX_MERGES",
    "ZOPEDIA_WIKI_MERGE_CANDIDATE_MAX_PAGES": "UNSLOTH_WIKI_MERGE_CANDIDATE_MAX_PAGES",
    "ZOPEDIA_WIKI_KNOWLEDGE_MAX_INCREMENTAL_UPDATES": "UNSLOTH_WIKI_KNOWLEDGE_MAX_INCREMENTAL_UPDATES",
    "ZOPEDIA_WIKI_COMPACTION_MAX_PAGES": "UNSLOTH_WIKI_COMPACTION_MAX_PAGES",
    # LLM
    "ZOPEDIA_WIKI_LLM_MAX_TOKENS": "UNSLOTH_WIKI_LLM_MAX_TOKENS",
    "ZOPEDIA_LLM_BASE_URL": "UNSLOTH_LLM_UPSTREAM_BASE_URL",
    "ZOPEDIA_LLM_API_KEY": "UNSLOTH_LLM_UPSTREAM_API_KEY",
    "ZOPEDIA_LLM_MODEL": "UNSLOTH_LLM_UPSTREAM_MODEL",
}
...
def apply_defaults() -> None:
    ...
    _setdefault("UNSLOTH_WIKI_MERGE_CANDIDATE_MAX_PAGES", "96")
