...
def research_survey_system_prompt(today: str, index_content: str, prior_report: str | None = None) -> str:
    prompt = (
        ...
        "If the topic involves stocks, options, or market data, use the "
        "alpaca_market_data and alpaca_news tools to pull live quotes, prices, "
        "volumes, options chains, or recent news — they are available when Alpaca "
        "is configured. "
...
def research_final_summary_system_prompt(
    ...
    prompt = (
        ...
        "If the topic involves stocks, options, or market data, also use the "
        "alpaca_market_data and alpaca_news tools to include live quotes, "
        "prices, volumes, options chains, or recent news when available.\n\n"
...
CHAT_COMPACT_PROMPT = (
    ...
    "This summary should be thorough in capturing technical details, wiki pages "
    "referenced, entities and concepts discussed, and decisions that would be "
    "essential for continuing work without losing context.\n\n"
    "Before providing your final summary, wrap your analysis in <analysis> tags "
    "to organize your thoughts and ensure you've covered all necessary points. "
    "In your analysis, chronologically analyze each message and section of the "
    "conversation. Identify the user's explicit requests, your approach, key "
    "decisions, wiki pages read, entities/concepts discussed, errors encountered "
    "and how they were fixed, and specific user feedback.\n\n"
    "Your summary should include the following sections:\n\n"
    "1. Primary Request and Intent: Capture all of the user's explicit requests "
    "and intents in detail.\n"
    "2. Key Technical Concepts: List all important concepts, wiki pages, and "
    "topics discussed.\n"
    "3. Wiki Pages and Sources: Enumerate specific wiki pages read, entities "
    "and concepts referenced, and sources ingested. Pay special attention to "
    ...
    "7. Pending Tasks: Outline any pending tasks that have been explicitly asked.\n"
    "8. Current Work: Describe precisely what was being worked on immediately "
    "before this summary request, paying special attention to the most recent "
    "messages from both user and assistant.\n"
    "9. Optional Next Step: List the next step directly in line with the user's "
    ...
    "   - [Concept 1]\n"
    "   - [Concept 2]\n\n"
    "3. Wiki Pages and Sources:\n"
    "   - [Page 1] - [why important]\n"
