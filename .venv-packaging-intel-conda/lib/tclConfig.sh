...
# installed.
TCL_PREFIX='/Users/zohairshafi/Local Workspace/zopedia/.venv-packaging-intel-conda'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/Users/zohairshafi/Local Workspace/zopedia/.venv-packaging-intel-conda'
...
TCL_EXTRA_CFLAGS='-march=core2 -mtune=haswell -mssse3 -ftree-vectorize -fPIC -fstack-protector-strong -O2 -pipe -isystem /Users/zohairshafi/Local Workspace/zopedia/.venv-packaging-intel-conda/include -fdebug-prefix-map=/Users/runner/miniforge3/conda-bld/tk_1769459952385/work=/usr/local/src/conda/tk-8.6.13 -fdebug-prefix-map=/Users/zohairshafi/Local Workspace/zopedia/.venv-packaging-intel-conda=/usr/local/src/conda-prefix -pipe  -D_FORTIFY_SOURCE=2 -isystem /Users/zohairshafi/Local Workspace/zopedia/.venv-packaging-intel-conda/include -mmacosx-version-min=10.13 -mmacosx-version-min=10.13 '
...
TCL_LD_FLAGS='-Wl,-headerpad_max_install_names -Wl,-dead_strip_dylibs -Wl,-rpath,/Users/zohairshafi/Local Workspace/zopedia/.venv-packaging-intel-conda/lib -L/Users/zohairshafi/Local Workspace/zopedia/.venv-packaging-intel-conda/lib -headerpad_max_install_names -Wl,-search_paths_first '
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/Users/zohairshafi/Local Workspace/zopedia/.venv-packaging-intel-conda/lib -ltcl8.6'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/Users/zohairshafi/Local Workspace/zopedia/.venv-packaging-intel-conda/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/Users/zohairshafi/Local Workspace/zopedia/.venv-packaging-intel-conda/include'
...
# compiled.
TCL_SRC_DIR='/Users/zohairshafi/Local Workspace/zopedia/.venv-packaging-intel-conda/include'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='{/Users/zohairshafi/Local Workspace/zopedia/.venv-packaging-intel-conda/lib} '
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/Users/zohairshafi/Local Workspace/zopedia/.venv-packaging-intel-conda/lib -ltclstub8.6'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/Users/zohairshafi/Local Workspace/zopedia/.venv-packaging-intel-conda/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/Users/zohairshafi/Local Workspace/zopedia/.venv-packaging-intel-conda/lib/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/Users/zohairshafi/Local Workspace/zopedia/.venv-packaging-intel-conda/lib/libtclstub8.6.a'
